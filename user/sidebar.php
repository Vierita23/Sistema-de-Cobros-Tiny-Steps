<nav class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li><a href="dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">Mi Panel</a></li>
        <li><a href="pagos.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'pagos.php' ? 'active' : ''; ?>">Mis Pagos</a></li>
        <li><a href="subir_pago.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'subir_pago.php' ? 'active' : ''; ?>">Subir Pago</a></li>
    </ul>
